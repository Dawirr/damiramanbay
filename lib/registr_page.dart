...
import 'package:damir1/user-info.dart';
import 'package:damir1/user.dart';
...
class _RegistrPageState extends State<RegistrPage> {
  ...
  final List<String> _countries = ['Russia', 'Ukraine', 'Germany', 'France','Nothing1'];
  String _selectedCountry = 'Nothing1';
  final List<String> _gender = ['Male', 'Female', 'Nothing'];
  String _selectedGender = 'Nothing';
